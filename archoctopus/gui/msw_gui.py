...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.4 on Thu Dec 29 14:57:12 2022
#
...
from archoctopus.gui.custom_widgets import svg_bitmap, get_bitmap, MyBitmap, MyAnimation, BasePopupCtrl, HistoryListCtrl
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.panel_2.SetMinSize(self.FromDIP((250, -1)))
        ...
        self.anim_ctrl = wx.adv.AnimationCtrl(self.panel_2, wx.ID_ANY, anim=MyAnimation(APP_ANIM_BUNDLE))
        ...
        self.panel_4.SetMinSize(self.FromDIP((-1, 70)))
        sizer_6.Add(self.panel_4, 1, wx.EXPAND, 0)

        sizer_2 = wx.BoxSizer(wx.VERTICAL)

        sizer_22 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_2.Add(sizer_22, 1, wx.EXPAND | wx.LEFT | wx.RIGHT, 10)
        ...
        self.start_ctrl.SetSize(self.start_ctrl.GetBestSize())
        self.start_ctrl.SetMinSize(self.FromDIP((70, -1)))
        ...
        self.panel_7.SetMinSize(self.FromDIP((-1, 30)))
        ...
        self.Layout()
        self.Centre()
        self.SetSize(self.FromDIP((850, 600)))
...
class SettingDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        _icon = wx.NullIcon
        _icon.CopyFromBitmap(svg_bitmap(SETTINGS).GetBitmapFor(self))
        self.SetIcon(_icon)
        ...
        label_23.SetMinSize(self.FromDIP((90, -1)))
        grid_sizer_3.Add(label_23, (0, 0), (1, 1), wx.ALIGN_CENTER_VERTICAL, 0)

        sizer_19 = wx.BoxSizer(wx.HORIZONTAL)
        grid_sizer_3.Add(sizer_19, (0, 1), (1, 1), wx.ALIGN_CENTER, 0)
        ...
        self.download_dir_btn.SetMinSize(self.FromDIP((100, -1)))
        ...
        self.download_dir_display.SetMinSize(self.FromDIP((160, -1)))
        ...
        self.loop_max_ctrl.SetMinSize(self.FromDIP((100, -1)))
        ...
        label_22 = wx.StaticText(self.general_panel, wx.ID_ANY, u"保存页面:")
        grid_sizer_3.Add(label_22, (3, 0), (1, 1), wx.ALIGN_CENTER_VERTICAL, 0)

        sizer_6 = wx.BoxSizer(wx.HORIZONTAL)
        grid_sizer_3.Add(sizer_6, (3, 1), (1, 1), wx.EXPAND, 0)

        self.pdf_toggle_ctrl = wx.BitmapToggleButton(self.general_panel, wx.ID_ANY, svg_bitmap(TOGGLE_OFF, 27, 27, colour=wx.Colour((160, 160, 160))), style=wx.BORDER_NONE | wx.BU_AUTODRAW | wx.BU_EXACTFIT | wx.BU_LEFT)
        ...
        sizer_6.Add(self.pdf_toggle_ctrl, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        sizer_6.Add((50, 0), 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.radio_btn_1 = wx.RadioButton(self.general_panel, wx.ID_ANY, "txt", style=wx.RB_GROUP)
        self.radio_btn_1.SetValue(1)
        sizer_6.Add(self.radio_btn_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.radio_btn_2 = wx.RadioButton(self.general_panel, wx.ID_ANY, "html")
        sizer_6.Add(self.radio_btn_2, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 5)

        self.radio_btn_3 = wx.RadioButton(self.general_panel, wx.ID_ANY, "pdf")
        sizer_6.Add(self.radio_btn_3, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 5)

        self.radio_btn_4 = wx.RadioButton(self.general_panel, wx.ID_ANY, "json")
        sizer_6.Add(self.radio_btn_4, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 5)
        ...
        label_25.SetMinSize(self.FromDIP((90, -1)))
        ...
        label_16.SetMinSize(self.FromDIP((90, -1)))
        ...
        label_20.SetMinSize(self.FromDIP((90, -1)))
        ...
        self.Layout()
        self.SetSize(self.FromDIP((450, 510)))
        self.CentreOnParent()

        self.Bind(wx.EVT_BUTTON, self.on_select_dir, self.download_dir_btn)
        self.Bind(wx.EVT_TOGGLEBUTTON, self.on_pdf, self.pdf_toggle_ctrl)
        self.Bind(wx.EVT_RADIOBUTTON, self.on_pdf_format, self.radio_btn_1)
        self.Bind(wx.EVT_RADIOBUTTON, self.on_pdf_format, self.radio_btn_2)
        self.Bind(wx.EVT_RADIOBUTTON, self.on_pdf_format, self.radio_btn_3)
        self.Bind(wx.EVT_RADIOBUTTON, self.on_pdf_format, self.radio_btn_4)
    ...
    def on_pdf(self, event):  # wxGlade: SettingDialog.<event_handler>
        print("Event handler 'on_pdf' not implemented!")
        event.Skip()

    def on_pdf_format(self, event):  # wxGlade: SettingDialog.<event_handler>
        print("Event handler 'on_pdf_format' not implemented!")
        event.Skip()
...
class HistoryDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        _icon = wx.NullIcon
        _icon.CopyFromBitmap(svg_bitmap(HISTORY).GetBitmapFor(self))
        self.SetIcon(_icon)
        ...
        self.panel_1.SetMinSize(self.FromDIP((180, -1)))
        ...
        self.panel_4.SetMinSize(self.FromDIP((-1, 40)))
        ...
        self.Layout()
        self.SetSize(self.FromDIP((800, 510)))
        self.CentreOnParent()
...
class TaskPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        sizer_3.Add(self.task_name, 1, wx.BOTTOM | wx.EXPAND, 5)
        ...
        self.imgs_sum.SetMinSize(self.FromDIP((100, -1)))
...
class SyncDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        _icon = wx.NullIcon
        _icon.CopyFromBitmap(svg_bitmap(SYNC).GetBitmapFor(self))
        self.SetIcon(_icon)
        ...
        self.Layout()
        self.SetSize(self.FromDIP((850, 540)))
        self.CentreOnParent()
...
class DonateDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.id_pair = {donate_25_id: DONATE_25_BUNDLE,
                        donate_50_id: DONATE_50_BUNDLE,
                        donate_75_id: DONATE_75_BUNDLE,
                        donate_100_id: DONATE_100_BUNDLE,
                        donate_other_id: DONATE_OTHER_BUNDLE}
        ...
        self.donation_list_btn.SetMinSize(self.FromDIP((-1, 50)))
        ...
        self.payment_qr = wx.StaticBitmap(self, wx.ID_ANY, get_bitmap(DONATE_50_BUNDLE), style=wx.BORDER_NONE)
...
class MyAbout(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.Layout()
        self.SetSize(self.FromDIP((580, 300)))
        self.CentreOnParent()
        # end wxGlade
...
class AccountPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        sizer_5 = wx.BoxSizer(wx.VERTICAL)
        sizer_4.Add(sizer_5, 1, wx.ALIGN_CENTER_VERTICAL, 0)

        self.avatar = wx.StaticBitmap(self.panel_3, wx.ID_ANY, svg_bitmap(ACCOUNT_CIRCLE, 100, 100, wx.Colour((160, 160, 160))))
        sizer_5.Add(self.avatar, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.TOP, 80)
...
class BoardPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.board_cover.SetMinSize(self.FromDIP((-1, 126)))
