...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.4 on Sun Feb 13 11:58:56 2022
#
...
from gui.custom_widgets import svg_bitmap
from gui.custom_widgets import MyBitmap
from gui.custom_widgets import MyAnimation
from gui.custom_widgets import BasePopupCtrl
from gui.custom_widgets import HistoryListCtrl
from gui import custom_outlinebtn
...
class SettingDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        sizer_1.Add(self.setting_nb, 0, wx.ALL | wx.EXPAND, 8)

        self.general_panel = wx.Panel(self.setting_nb, wx.ID_ANY)
        self.general_panel.SetFont(wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        ...
        self.download_dir_btn.SetMinSize((85, -1))
        ...
        self.proxy_panel.SetFont(wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        ...
        self.custom_panel.SetFont(wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        ...
        self.filter_panel.SetFont(wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
...
class TaskPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.task_name.SetFont(wx.Font(15, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        # print(self.task_name.GetFont().GetNativeFontInfoDesc())
        sizer_3.Add(self.task_name, 1, wx.EXPAND | wx.TOP, 5)
...
class TagPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        tag_bitmap = wx.StaticBitmap(self, wx.ID_ANY, svg_bitmap(TAG), style=wx.BORDER_NONE)
        sizer_2.Add(tag_bitmap, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        desc = wx.StaticText(self, wx.ID_ANY, u"添加标签, 使用“;”分割.")
        desc.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        sizer_2.Add(desc, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT | wx.RIGHT | wx.TOP, 5)

        self.tags_edit_ctrl = wx.TextCtrl(self, wx.ID_ANY, "")
        self.tags_edit_ctrl.SetMinSize((350, -1))
        sizer_1.Add(self.tags_edit_ctrl, 0, wx.BOTTOM | wx.EXPAND | wx.LEFT | wx.RIGHT, 5)
...
class SyncDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.SetIcon(_icon)
        self.SetFont(wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_LIGHT, 0, ""))
...
class DonateDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.SetFont(wx.Font(13, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        ...
        label_4.SetFont(wx.Font(20, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Microsoft YaHei UI"))
        ...
        self.Bind(wx.EVT_BUTTON, self.on_sponsor_page, self.donation_list_btn)
    ...
    def on_sponsor_page(self, event):  # wxGlade: DonateDialog.<event_handler>
        print("Event handler 'on_sponsor_page' not implemented!")
        event.Skip()
...
class MyAbout(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.panel_2.SetForegroundColour(wx.Colour(255, 255, 255))
        self.panel_2.SetFont(wx.Font(13, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        sizer_3.Add(self.panel_2, 1, wx.EXPAND, 0)

        sizer_4 = wx.BoxSizer(wx.HORIZONTAL)

        sizer_6 = wx.BoxSizer(wx.VERTICAL)
        sizer_4.Add(sizer_6, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 25)

        avatar = wx.StaticBitmap(self.panel_2, wx.ID_ANY, MyBitmap(APP_ABOUT_ICON), style=wx.BORDER_NONE)
        sizer_6.Add(avatar, 0, 0, 0)

        sizer_7 = wx.BoxSizer(wx.VERTICAL)
        sizer_4.Add(sizer_7, 1, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 15)

        grid_sizer_1 = wx.FlexGridSizer(3, 1, 10, 0)
        sizer_7.Add(grid_sizer_1, 1, wx.EXPAND, 0)

        name = wx.StaticText(self.panel_2, wx.ID_ANY, u"ArchOctopus — 建筑师收集助手")
        name.SetFont(wx.Font(25, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        grid_sizer_1.Add(name, 0, wx.BOTTOM, 20)

        self.release_info = wx.StaticText(self.panel_2, wx.ID_ANY, u"版本：1.840 64bit\n日期：Jan 01 2019")
        self.release_info.SetFont(wx.Font(13, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        grid_sizer_1.Add(self.release_info, 0, wx.ALL, 0)

        about = wx.StaticText(self.panel_2, wx.ID_ANY, u"本程序起源于本人日常工作上的需要。\n旨在帮助建筑师快速、批量化的收集建筑设计类的素材资料。\n任何人均可随意使用或分发，但不得用于任何盈利目的。")
        grid_sizer_1.Add(about, 0, wx.ALL, 0)

        self.panel_3 = wx.Panel(self, wx.ID_ANY)
        self.panel_3.SetMinSize((-1, 60))
        self.panel_3.SetBackgroundColour(wx.Colour(90, 90, 90))
        self.panel_3.SetForegroundColour(wx.Colour(255, 255, 255))
        self.panel_3.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 1, ""))
        ...
        label_4.SetForegroundColour(wx.Colour(150, 150, 150))
...
class AccountPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.site_dir_btn = wx.Button(self.panel_3, wx.ID_ANY, u"打开同步文件夹")
...
class BoardPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.board_name.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
...
class TagsPopupCtl(BasePopupCtrl):
    def __init__(self, *args, **kwds):
        ...
        self.tags_edit_ctrl = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.TE_DONTWRAP | wx.TE_PROCESS_ENTER)
        self.tags_edit_ctrl.SetMinSize((350, -1))
